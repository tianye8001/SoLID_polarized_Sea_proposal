...
//         }
      ...
      if(pid_gen==11 && Q2_gen>1 /*&& W_gen>2 i*/&& p_gen>3.0){
...
TFile *outputfile_final=new TFile("analysis_8.8GeV_LA_threshold3GeV_noWcut_Longitudinal.root", "recreate");
